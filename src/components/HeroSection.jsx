  ...
  return (
    <section className="relative   w-full overflow-hidden" ref={heroRef}>
      <div
        style={{
          position: "relative",
          backgroundImage: `url('/sobha-hartland2/backgrounds/heroBg.webp')`,
          backgroundAttachment: "fixed",
          backgroundSize: "cover",
          backgroundPosition: "center",
        }}
        className={`relative w-full  h-[68vh] md:h-screen `}
      >
        <div className="absolute inset-0 bg-gradient-to-r from-black/80 via-black/50 to-transparent w-[70%]"></div>
        <div className="absolute top-12 left-1/2 -translate-x-1/2 z-[3] text-center">
          <h1 className="text-[#000000] h3 !tracking-normal">
            <span className="uppercase tracking-tighter">
              Invest Right in the{" "}
            </span>
            <br className="md:hidden" />
            <span className="italic h1 !tracking-normal">Centre of Dubai</span>
          </h1>
        </div>

        <div className="relative left-0 top-1/2 -translate-y-1/2 z-[3] flex justify-start items-center mainContainer mx-auto">
          <div className="space-y-6 md:space-y-6 text-white ">
            <LocationItem
      ...
      <div>
        ...
        >
          <div className="mainContainer mx-auto flex flex-col sm:flex-row gap-3 items-center justify-start">
            ...
            <Button
              variant="white"
              className=" flex items-center justify-center gap-2 !pl-4 !pr-6 !font-bold"
              onClick={onOpenPopup}
            >
              <Image
...
function LocationItem({ title, subtitle }) {
  return (
    <div className="flex items-start gap-3">
      ...
      />
      <div>
        <p className="h3 font-semibold tracking-wide">{title}</p>
