...
export default function AboutSection() {
  return (
    <section className="relative w-full bg-[#ffffff] pt-10 lg:pb-10 rounded-t-[30px] overflow-hidden -translate-y-6">
      {/* Top colored overlay */}
      <div className="absolute top-0 left-0 w-full h-[140px] bg-gradient-to-b from-[#d4d3d4] via-[#d4d3d4]/10 to-transparent rounded-t-2xl pointer-events-none"></div>
      ...
      <div className="mainContainer mx-auto mt-14 grid grid-cols-1 lg:grid-cols-12 items-center gap-10 md:gap-20">
        ...
        <div className="w-full  text-gray-900 p1 leading-relaxed text-[17px] lg:col-span-5">
          <p className="mb-8">
            ...
            of Sobha Hartland, redefining luxury living across 8 million square
            feet. Located near its predecessor, this exceptional community
            seamlessly blends urban convenience with natural beauty, offering
            residents easy access to the city’s top malls, business districts,
            and attractions, while providing a peaceful escape in a vibrant,
            centrally connected sanctuary.
          </p>
